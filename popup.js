function updateRecents() {
  ...
  for (var prop in bg.recent_url) {
    document.getElementById("recent").innerHTML += "<li><a href=" + bg.recent_url[prop] + ">" + bg.recent_title[prop] + "</a></li>"
  }
}
...
document.getElementById("set").onclick = function() {
  ...
  if(siteListset.has(d)) {
    ...
    // must also delete from storage
    chrome.storage.sync.set({"site_list": siteListset}, function() {
      bg.console.log('Deleted item from storage ' + d);
    });
